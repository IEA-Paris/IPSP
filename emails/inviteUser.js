module.exports = ({
  ...
  logo,
  unsub: false,
  preview: "You have been invited to be a IPSP referent",
  emailSubject: "You have been invited to be a IPSP referent",
  content: `<p>Dear ${firstName} ${lastName},</p>
  <p>We are happy to inform you that you have been selected and invited to be a IPSP referent.</p>
  <p>Please click on the link below to define your password and join us on IPSP for referents.</p>
  ...
  We are happy to inform you that you have been selected and invited to be a IPSP referent.
  Please click on the link below to define your password and join us on IPSP for referents.
  ${link} 
